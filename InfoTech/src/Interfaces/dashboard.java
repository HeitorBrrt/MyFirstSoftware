...
public class dashboard {
    ...
    private void searchClientPanelMouseClicked(MouseEvent e) {
        ...
        try {
            ...
            ediClienteUserField.setText(db.getIdUser_info(conn, "cliente", searchID.getText()));
    ...
    private void searchFuncMouseClicked(MouseEvent e) {
        ...
        try {
            ...
            edifuncUserField.setText(db.getUser_info(conn, "usuario", searchUser.getText()));
            edifuncSenField.setText(db.getSenha_info(conn, "usuario", searchUser.getText()));
            edifuncQtdField.setText(db.getQtdVendas_info(conn, "usuario", searchUser.getText()));
            edifuncTipoField.setText(db.getUsuarioTipo_info(conn, "usuario", searchUser.getText()));
    ...
    private void searchProdPanelMouseClicked(MouseEvent e) {
        ...
        if((ediProdNomeField.getText().length()>0) && (ediProdTelefoneField.getText().length()>0) && (ediProdEndField.getText().length()>0)
            && (ediProdPrecoCompra.getText().length()>0) && (ediProdPrecoVenda.getText().length()>0) && (ediProdDataField.getText().length()>0)){
            try{
                ediProdNomeField.setText(db.getNome_info(conn, "produto", "idproduto", searchIdProduto.getText()));
                ediProdTelefoneField.setText(db.getProductFone_info(conn, "produto", searchIdProduto.getText()));
                ediProdEndField.setText(db.getProductEndereco_info(conn, "produto", searchIdProduto.getText()));
                ediProdPrecoCompra.setText(db.getPrecoCompra_info(conn, "produto", searchIdProduto.getText()));
                ediProdPrecoVenda.setText(db.getPrecoVenda_info(conn, "produto", searchIdProduto.getText()));
    ...
    private void prodSaveBttMouseClicked(MouseEvent e) {
        ...
        if((cadProdNomeField.getText().length()>0) && (cadProdTelefoneField.getText().length()>0) &&
            ...
            try{
                Produto produto = new Produto(null, nome, telefoneImportadora, enderecoImportadora, precoCompra, precoVenda, dataCadastro);
                db.insert_row_produto(conn, "produto",
        ...
        if(((ediProdNomeField.getText().length()>0) && (ediProdTelefoneField.getText().length()>0) &&
            ...
            try {
                db.update_produto(conn, "produto",
                        ...
                        ediProdPrecoCompra.getText(),
                        ediProdPrecoVenda.getText(),
    ...
    private void SaveBttVendasMouseClicked(MouseEvent e) {
        ...
        Float precoTotal = 0f;
        String idCliente = venIdCliente.getText(); // TODO: pegar precoTotal a partir de selects;
        String idUsuario = venUser.getText();
        Integer qtdItem = Integer.parseInt(venQtd.getText());
        String idProduto = venIdProduto.getText();
        ...
        if((venIdProduto.getText().length()>0) && (venQtd.getText().length()>0) && (venUser.getText().length()>0) && (venIdCliente.getText().length()>0)){
            try{
                Venda venda = new Venda(null, precoTotal, datavenda, Integer.parseInt(idCliente), idUsuario, qtdItem, idProduto);
                db.insert_row_venda(conn, "venda", venda.getIdCliente(), venda.getIdUsuario(), venda.getPrecoTotal(), venda.getDataVenda());
    ...
    private void addBttVendasMouseClicked(MouseEvent e) {
        fichaTextPane.setText(fichaTextPane.getText()+
                "ID do produto: "+ venIdProduto.getText()+"\n" +
                "Quantidade: "+ venQtd.getText()+"\n"+
                "ID do Cliente: "+venIdCliente.getText()+"\n" +
                "ID Usuário: "+ venUser.getText()+"\n\n"                
        );
    }

    private void ClearBttVendasMouseClicked(MouseEvent e) {
        venIdProduto.setText("");
        venQtd.setText("");
        venUser.setText("");
        venIdCliente.setText("");
    }
    ...
    private void initComponents() {
        ...
        label60 = new JLabel();
        label61 = new JLabel();
        venIdProduto = new JTextField();
        separator40 = new JSeparator();
        scrollPane1 = new JScrollPane();
        fichaTextPane = new JTextPane();
        label62 = new JLabel();
        venUser = new JTextField();
        separator42 = new JSeparator();
        label63 = new JLabel();
        venIdCliente = new JTextField();
        label65 = new JLabel();
        venQtd = new JTextField();
        ...
        //======== mainPanel ========
        {
            ...
            //======== panel3 ========
            {
                ...
                //======== verTabelasBtt ========
                {
                    ...
                    verTabelasBttLayout.setVerticalGroup(
                        verTabelasBttLayout.createParallelGroup()
                            .addComponent(label59, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                    );
                }
                ...
                //======== efetuarVendaBtt ========
                {
                    ...
                    efetuarVendaBttLayout.setVerticalGroup(
                        efetuarVendaBttLayout.createParallelGroup()
                            .addGroup(efetuarVendaBttLayout.createSequentialGroup()
                                .addComponent(label57, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                    );
                }
                            ...
                            .addGroup(panel3Layout.createParallelGroup()
                                ...
                                .addGroup(panel3Layout.createSequentialGroup()
                                    .addGroup(panel3Layout.createParallelGroup()
                                        ...
                                        .addComponent(funcBtt1, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(cliBtt2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(cliBtt1, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(prodBtt2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(prodBtt1, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            //======== centralPane ========
            {
                ...
                //======== efetuarVendaPanel ========
                {
                    ...
                    //---- venIdProduto ----
                    venIdProduto.setBorder(null);
                    venIdProduto.setForeground(Color.white);
                    venIdProduto.setBackground(new Color(0x21252f));
                    ...
                    //======== scrollPane1 ========
                    {
                        ...
                        //---- fichaTextPane ----
                        fichaTextPane.setFocusable(false);
                    ...
                    //---- venUser ----
                    venUser.setBorder(null);
                    venUser.setForeground(Color.white);
                    venUser.setBackground(new Color(0x21252f));
                    ...
                    //---- venIdCliente ----
                    venIdCliente.setForeground(Color.white);
                    venIdCliente.setBorder(null);
                    venIdCliente.setBackground(new Color(0x21252f));
                    ...
                    //---- venQtd ----
                    venQtd.setBorder(null);
                    venQtd.setBackground(new Color(0x21252f));
                    venQtd.setForeground(Color.white);
                                        ...
                                        .addGroup(efetuarVendaPanelLayout.createParallelGroup()
                                            ...
                                            .addGroup(efetuarVendaPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                                ...
                                                .addGroup(efetuarVendaPanelLayout.createSequentialGroup()
                                                    ...
                                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                    .addComponent(ClearBttVendas, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                                    .addGroup(efetuarVendaPanelLayout.createSequentialGroup()
                                        .addGap(103, 103, 103)
                    ...
                    efetuarVendaPanelLayout.setVerticalGroup(
                        efetuarVendaPanelLayout.createParallelGroup()
                            ...
                            .addGroup(GroupLayout.Alignment.TRAILING, efetuarVendaPanelLayout.createSequentialGroup()
                                ...
                                .addComponent(label61)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(venIdProduto, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(separator40, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(label65)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(venQtd, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(separator45, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addGap(12, 12, 12)
                                .addComponent(label62)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(venUser, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(separator42, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(label63)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(venIdCliente, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(ediFuncionarioPanelLayout.createParallelGroup()
                                    ...
                                    .addGroup(ediFuncionarioPanelLayout.createSequentialGroup()
                                        .addGroup(ediFuncionarioPanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(label28, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                            .addGroup(GroupLayout.Alignment.LEADING, ediFuncionarioPanelLayout.createSequentialGroup()
                            ...
                            .addGroup(cadClientePanelLayout.createSequentialGroup()
                                ...
                                .addGroup(cadClientePanelLayout.createParallelGroup()
                                    ...
                                    .addGroup(cadClientePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(separator1, GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
                                        .addComponent(label13, GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
                                        ...
                                        .addComponent(clearBtt, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        cadProdutoPanelLayout.createParallelGroup()
                            .addGroup(cadProdutoPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(cadProdutoPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(label26, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cadProdEndField, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(separator39, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label23, GroupLayout.PREFERRED_SIZE, 153, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cadProdPrecoCompra, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(separator15, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label24, GroupLayout.PREFERRED_SIZE, 146, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cadProdPrecoVenda, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(separator13, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label27)
                                    .addGroup(cadProdutoPanelLayout.createSequentialGroup()
                                        .addComponent(prodSaveBtt, GroupLayout.PREFERRED_SIZE, 186, GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(prodClearBtt, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                .addGap(0, 786, Short.MAX_VALUE))
                    );
                    cadProdutoPanelLayout.setVerticalGroup(
                        cadProdutoPanelLayout.createParallelGroup()
                            .addGroup(GroupLayout.Alignment.TRAILING, cadProdutoPanelLayout.createSequentialGroup()
                                .addGroup(cadProdutoPanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(cadProdutoPanelLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(separator15, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                        ...
                                        .addGap(18, 18, 18)
                                        .addGroup(cadProdutoPanelLayout.createParallelGroup()
                        ...
                        ediProdutoPanelLayout.createParallelGroup()
                            .addGroup(ediProdutoPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(ediProdutoPanelLayout.createParallelGroup()
                                    ...
                                    .addComponent(ediProdPrecoCompra, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addComponent(ediProdPrecoVenda, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                    ...
                    //======== panel5 ========
                    {
                        ...
                        //======== tabelaUsuariosPanel ========
                        {
                            ...
                            //======== usuariosScroll ========
                            {
                                ...
                                usuariosTable.setSelectionForeground(Color.black);
                                usuariosTable.setSelectionBackground(Color.black);
                        ...
                        //======== tabelaClientesPanel ========
                        {
                            ...
                            //======== clientesScroll ========
                            {
                                ...
                                clientesTable.setSelectionBackground(Color.black);
                            ...
                            tabelaClientesPanelLayout.setHorizontalGroup(
                                tabelaClientesPanelLayout.createParallelGroup()
                                    .addComponent(clientesScroll, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 1260, Short.MAX_VALUE)
                            );
                        ...
                        //======== tabelaProdutosPanel ========
                        {
                            ...
                            tabelaProdutosPanel.setForeground(Color.black);
                            ...
                            //======== produtosScroll ========
                            {
                                ...
                                produtosTable.setModel(new DefaultTableModel(
                                    ...
                                    new String[] {
                                        "idProduto", "Nome", "Telefone da Importadora", "Endere\u00e7o da Importadora", "Pre\u00e7o de compra", "Pre\u00e7o de Venda", "Data de cadastro"
                                    }
                                ));
                                produtosTable.setGridColor(new Color(0xffff66));
                                produtosTable.setForeground(Color.black);
                                produtosTable.setBackground(new Color(0x21252f));
                                produtosTable.setSelectionForeground(Color.black);
                                produtosTable.setSelectionBackground(Color.black);
                        ...
                        //======== tabelaVendas ========
                        {
                            ...
                            //======== vendasScroll ========
                            {
                                ...
                                vendasTable.setModel(new DefaultTableModel(
                                    ...
                                    new String[] {
                                        "idVenda", "idCliente", "idUsuario", "Pre\u00e7o total", "Data da venda"
                                    }
                                ));
                                vendasTable.setBackground(new Color(0x21252f));
                                vendasTable.setForeground(new Color(0x009933));
                                vendasTable.setGridColor(new Color(0x009933));
                                vendasTable.setSelectionForeground(Color.black);
                                vendasTable.setSelectionBackground(Color.black);
                            ...
                            tabelaVendasLayout.setHorizontalGroup(
                                tabelaVendasLayout.createParallelGroup()
                                    .addComponent(vendasScroll, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 1260, Short.MAX_VALUE)
                            );
                    ...
                    verTabelasPanelLayout.setHorizontalGroup(
                        verTabelasPanelLayout.createParallelGroup()
                            ...
                            .addGroup(GroupLayout.Alignment.TRAILING, verTabelasPanelLayout.createSequentialGroup()
                                .addComponent(panel5, GroupLayout.DEFAULT_SIZE, 1266, Short.MAX_VALUE)
                                .addContainerGap())
                    );
    ...
    private JTextField venIdProduto;
    private JSeparator separator40;
    private JScrollPane scrollPane1;
    private JTextPane fichaTextPane;
    private JLabel label62;
    private JTextField venUser;
    private JSeparator separator42;
    private JLabel label63;
    private JTextField venIdCliente;
    private JLabel label65;
    private JTextField venQtd;
    ...
    public static void main(String[] args) {
        ...
        frame.pack();
        frame.setContentPane(new Interfaces.dashboard().mainPanel);
