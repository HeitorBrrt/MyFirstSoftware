...
public class dashboard {
    ...
    private void searchProdPanelMouseClicked(MouseEvent e) {
        ...
        if((ediProdNomeField.getText().length()>0) && (ediProdTelefoneField.getText().length()>0) && (ediProdEndField.getText().length()>0)
            ...
            try{
                ...
                ediProdTelefoneField.setText(db.getProductFone_info(conn, "produto", Integer.valueOf(searchIdProduto.getText())));
                ediProdEndField.setText(db.getProductEndereco_info(conn, "produto", Integer.valueOf(searchIdProduto.getText())));
                ediProdPrecoCompra.setText(db.getPrecoCompra_info(conn, "produto", Integer.valueOf(searchIdProduto.getText())));
                ediProdPrecoVenda.setText(db.getPrecoVenda_info(conn, "produto", Integer.valueOf(searchIdProduto.getText())));
    ...
    private void prodSaveBttMouseClicked(MouseEvent e) {
        ...
        if((cadProdNomeField.getText().length()>0) && (cadProdTelefoneField.getText().length()>0) &&
            ...
            try{
                Produto produto = new Produto(1138, nome, telefoneImportadora, enderecoImportadora, quantidade, precoCompra, precoVenda, dataCadastro);
    ...
    private void SaveBttVendasMouseClicked(MouseEvent e) {
        ...
        Float precoTotal = 0f;
        String idCliente = venIdClienteField.getText(); // TODO: pegar precoTotal a partir de selects;
        String idUsuario = venUserField.getText();
        Integer qtdItem = Integer.parseInt(venQtdField.getText());
        ...
        if((venIdProdutoField.getText().length()>0) && (venQtdField.getText().length()>0) && (venUserField.getText().length()>0) && (venIdClienteField.getText().length()>0)){
            try{
    ...
    private void addBttVendasMouseClicked(MouseEvent e) {
        fichaTextPane.setText(fichaTextPane.getText()+
                ...
                "ID Usuário: "+ venUserField.getText()+"\n\n"
        );
    }
        ...
        //======== mainPanel ========
        {
                            ...
                            .addGroup(panel3Layout.createParallelGroup()
                                ...
                                .addGroup(GroupLayout.Alignment.TRAILING, panel3Layout.createSequentialGroup()
                                    .addGroup(panel3Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addComponent(funcBtt2, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(funcBtt1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(cliBtt2, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(cliBtt1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(prodBtt2, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(prodBtt1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(verTabelasBtt, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(efetuarVendaBtt, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                    .addGap(24, 24, 24))))
                );
            ...
            //======== centralPane ========
            {
                ...
                //======== efetuarVendaPanel ========
                {
                    ...
                    //---- venUserField ----
                    venUserField.setBorder(null);
                    venUserField.setForeground(Color.white);
                    venUserField.setBackground(new Color(0x21252f));
                    ...
                    efetuarVendaPanelLayout.setVerticalGroup(
                        efetuarVendaPanelLayout.createParallelGroup()
                            ...
                            .addGroup(GroupLayout.Alignment.TRAILING, efetuarVendaPanelLayout.createSequentialGroup()
                                ...
                                .addComponent(label62)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(venUserField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        cadProdutoPanelLayout.createParallelGroup()
                            .addGroup(cadProdutoPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(cadProdutoPanelLayout.createParallelGroup()
                                    ...
                                    .addComponent(cadQuantidadeField, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(separator27, GroupLayout.PREFERRED_SIZE, 380, GroupLayout.PREFERRED_SIZE)
                                    .addGroup(cadProdutoPanelLayout.createSequentialGroup()
    ...
    private JTextField venUserField;
