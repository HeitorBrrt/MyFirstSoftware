...
public class dashboard {
    ...
    private void SaveBttVendasMouseClicked(MouseEvent e) {
        ...
        if((venIdProdutoField.getText().length()>0) && (fichaTextPane.getText().length()>0) &&
                (venQtdField.getText().length()>0) && (venUserField.getText().length()>0) &&
            ...
            try{
                ...
                db.insert_row_venda(conn, "venda", venda.getDescricao(),venda.getIdCliente(), venda.getIdUsuario(), venda.getPrecoTotal(), venda.getDataVenda());
    ...
    private void addBttVendasMouseClicked(MouseEvent e) {
        if((venIdProdutoField.getText().length()>0) && (venQtdField.getText().length()>0) && (venIdClienteField.getText().length()>0) && (venUserField.getText().length()>0)){
    ...
    private String precTot(Integer idproduto, String quantidade) {
        DbFunctions db = new DbFunctions();
        Connection conn = db.connect_to_db("InfoTech", "postgres", "lbj23kb24mj45");
        String precoVend = db.getPrecoVenda_info(conn, idproduto);
                        ...
                        //======== tabelaVendas ========
                        {
                            ...
                            //======== vendasScroll ========
                            {
                                ...
                                vendasTable.setModel(new DefaultTableModel(
                                    ...
                                    new String[] {
                                        "Identificador da venda", "Descri\u00e7\u00e3o", "Identificador do cliente", "Identificador do ususario", "Pre\u00e7o total", "Data da venda"
                                    }
                                ));
