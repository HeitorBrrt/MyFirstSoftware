...
public class DbFunctions {
    ...
    public void insert_row_funcionario(Connection conn, String table_name, String user, String name, String number, String address, String password, String usertype, String datacadastro){
        Statement statement;
        try{
            String query = String.format("insert into %s(usuario, nome, telefone, endereco, senha, qtdvendas, usuariotipo, datacadastro) values('%s', '%s', '%s', '%s', '%s', '0', '%s', '%s');", table_name, user, name, number, address, password, usertype, datacadastro);
            statement=conn.createStatement();
            statement.executeUpdate(query);
        }catch (Exception e){
            JOptionPane.showMessageDialog(null, e);
    ...
    public void insert_row_produto(Connection conn, String table_name, String idProduto, String name, String number, String address, String precoCompra, String precoVenda, String datacadastro){
        Statement statement;
        try {
            String query = String.format("insert into %s(idProduto, nome, telefoneimportadora, enderecoimportadora, precoCompra, precoVenda, datacadastro) values ('%s', '%s', '%s', '%s', '%s', '%s', '%s');", table_name, idProduto, name, number, address, precoCompra, precoVenda, datacadastro);
            statement = conn.createStatement();
            statement.executeUpdate(query);
        }catch (Exception e){
            JOptionPane.showMessageDialog(null, e);
    ...
    public void insert_row_venda(Connection conn, String table_name, int idCliente, String userUsuario, float precototal, String datavenda){
        Statement statement;
        try {
    ...
    public String getProductID_info(Connection conn, String table_name, String idproduto){
        Statement statement;
        ResultSet rs;
        try {
    ...
    public String getProductFone_info(Connection conn, String table_name, String idproduto){
        Statement statement;
        ResultSet rs;
        try {
    ...
    public String getProductEndereco_info(Connection conn, String table_name, String idproduto){
        Statement statement;
        ResultSet rs;
        try {
    ...
    public String getPrecoCompra_info(Connection conn, String table_name, String idproduto){
        Statement statement;
        ResultSet rs;
        try {
    ...
    public String getPrecoVenda_info(Connection conn, String table_name, String idproduto){
        Statement statement;
        ResultSet rs;
        try {
    ...
    public List<Cliente> read_dataClientes(Connection conn){
        ...
        try{
            ...
            while (rs2.next()) {
                ...
                cliente.setUserUsuario(rs2.getString("userusuario"));
    ...
    public List<Produto> read_dataProdutos(Connection conn){
        ...
        try{
            ...
            while (rs3.next()){
                ...
                produto.setTelefoneImportadora(rs3.getString("telefoneimportadora"));
                produto.setEnderecoImportadora(rs3.getString("enderecoimportadora"));
